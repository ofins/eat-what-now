...
const CommentSection: React.FC<CommentSectionProps> = ({
  ...
  const renderComment = (
    ...
    return (
      <div
        key={`comment-${index}`}
        className={`bg-white rounded-lg p-2 shadow-sm ${isUserComment ? "border-l-4 border-blue-500 mb-2" : ""}`}
      >
    ...
    if (commentsToShow.length > 0) {
      return (
        <div className="flex-shrink-0 mt-1">
          ...
          <div className="space-y-1">{commentsToShow}</div>
        </div>
      );
    }
  ...
  return (
    <div className="flex-shrink-0 flex flex-col h-full">
      ...
      >
        ...
        <div className="bg-gray-50 rounded-lg p-2 space-y-2 min-h-[120px] flex-1 mb-3">
          ...
          restaurant.comments.length > 0 ? (
            <div className="space-y-2">
              <h4 className="font-medium text-xs text-gray-700 mt-1 mb-2">
          ...
          (isCommenting ? (
            ...
            >
              <div className="mb-2">
                <textarea
                  ref={textareaRef}
                  className="w-full px-2 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-xs"
                  rows={3}
              ...
              <div className="flex justify-end gap-2">
                <button
                  type="button"
                  className="px-2 py-1 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 text-xs font-medium transition-colors"
                  onClick={() => {
                ...
                <button
                  type="submit"
                  className="px-2 py-1 bg-blue-500 text-white rounded-md hover:bg-blue-600 text-xs font-medium transition-colors disabled:bg-blue-300"
            ...
            <div className="bg-white rounded-lg p-2 shadow-sm">
              <button
                className="w-full px-2 py-2 text-left text-gray-500 border border-dashed border-gray-300 rounded-lg hover:border-blue-400 hover:text-blue-500 transition-colors cursor-pointer"
